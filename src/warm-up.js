...
var food = "Caprese Crackers";
var type = "hors d'oeuvres";
var inStock = 1;
// var food = "Ice Cream";
// var type = "Dessert";
// var inStock = 10
...
if (inStock < 20) {
   console.log("should order more: ", shouldOrderMore = true);
} else {
  console.log("should order more: ", shouldOrderMore = false);
}
...
var vegetables = ["Carrots", "Lettuice", "Arugala", "Onion", "Broccoli"];
...
// different fruits.
var fruits = ["Apples", "Mangos", "Strawberries", "Kanalope", "Dragon Fruit", "Kiwi", "Oranges"];
